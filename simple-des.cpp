...
*               char ciphertext[]: Export; Resulting output of permutation.    *
*   Return Value: None.                                                        *
*******************************************************************************/
...
*                resulting in the 8-bit ciphertext, which is printed out.      *
*******************************************************************************/
// input 1: preIP1, input 2: postIP2, output: ciphertext
// Normally: 4 1 3 5 7 2 8 6
// In array: 3 0 2 4 6 1 7 5 
void IP1(char preIP1[], char postIP2[], char ciphertext[])
{
    char temp[8];
